...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/student/report" element={<Protected role="student"><StudentReport /></Protected>} />
      <Route path="/student/download" element={<Protected role="student"><StudentDownload /></Protected>} />
